...
// Placeholder pra cena de cutscene final da M04. Mostra "FIM DA MEMÓRIA" + botão
// "Voltar ao Menu". Substituível pela cutscene real quando essa for produzida.
// Espelha SchoolPlaceholderBuilder.
public static class Memory04CutscenePlaceholderBuilder
{
    ...
    static readonly Color SubtleCol = new Color(0.7f, 0.85f, 1f, 0.85f);

    [MenuItem("Retroself/Build Memory_04_Cutscene Placeholder")]
    public static void BuildCutscenePlaceholder()
    {
        ...
        Debug.Log($"[Memory04CutscenePlaceholderBuilder] Cena salva em {ScenePath}.");
    }
    ...
    static void BuildCanvas(GameObject menuGO)
    {
        ...
        CreateUIText(canvasGO.transform, "Title", "FIM DA MEMORIA", 80, FontStyles.Bold,
            new Vector2(0, 200), new Vector2(1600, 140), CreamCol);

        CreateUIText(canvasGO.transform, "Subtitle",
            "Cutscene final em producao.",
            32, FontStyles.Italic,
    ...
    static void BuildBackButton(Transform parent, GameObject menuGO)
    {
        ...
        img.color = new Color(0.12f, 0.10f, 0.18f, 0.9f);
        ...
        CreateUIText(btnGO.transform, "Label", "Voltar ao Menu", 32, FontStyles.Bold,
